...
// Function to check visibility of "My Account" icon
// async function checkMyAccountIconVisibility(page) {
//   const myAccountIcon = await page.locator('.nav-v2-avatar__image');

//   // Check if the "My Account" icon is visible
//   expect(await myAccountIcon.isVisible()).toBeTruthy();
// }
...
async function search(page, query) {
  ...
  // Hover over the avatar to reveal the sign out option
...
test.describe('Login Tests', () => {
  ...
  // test('My Account icon should be visible after login', async ({ page }) => {
  //   await navigateToHomePage(page);
  //   await login(page, 'rijanmajhi2121@gmail.com', 'bips123@');
  //   await checkMyAccountIconVisibility(page);
  // });
});
...
test.describe('Search Tests Filter and Sign Out Tests', () => {
  test.only('Should search for a logo  Filter and Sign Out Tests', async ({ page }) => {
    await navigateToHomePage(page);
    await login(page, 'rijanmajhi2121@gmail.com', 'bips123@');
...
//   test('Should apply filters and sign out', async ({ page }) => {
//     await navigateToHomePage(page);
//     await login(page, 'rijanmajhi2121@gmail.com', 'bips123@');
